...
if(isset($_POST['update'])){
   ...
   if(!empty($image_01)){
      if($image_size_01 > 2000000){
         $message[] = 'La Primera Imagen es Muy Larga!';
      }else{
         $update_image_01 = $conn->prepare("UPDATE `products` SET image_01 = ? WHERE id = ?");
         $update_image_01->execute([$image_01, $pid]);
         move_uploaded_file($image_tmp_name_01, $image_folder_01);

         // Verificar si el archivo antiguo existe antes de eliminarlo
         if (file_exists('../../assets/uploaded_img/' . $old_image_01)) {
             unlink('../../assets/uploaded_img/' . $old_image_01);
         }
         $message[] = 'Primera Imagen Actualizada Exitosamente!';
      }
   }
   ...
   if(!empty($image_02)){
      if($image_size_02 > 2000000){
         $message[] = 'La Segunda Imagen es Muy Larga!';
      }else{
         ...
         // Verificar si el archivo antiguo existe antes de eliminarlo
         if (file_exists('../../assets/uploaded_img/' . $old_image_02)) {
             unlink('../../assets/uploaded_img/' . $old_image_02);
         }
         $message[] = 'Segunda Imagen Actualizada Exitosamente!';
      }
   }
   ...
   if(!empty($image_03)){
      if($image_size_03 > 2000000){
         $message[] = 'La Tercera Imagen es Muy Larga!';
      }else{
         ...
         // Verificar si el archivo antiguo existe antes de eliminarlo
         if (file_exists('../../assets/uploaded_img/' . $old_image_03)) {
             unlink('../../assets/uploaded_img/' . $old_image_03);
         }
         $message[] = 'Tercera Imagen Actualizada Exitosamente!';
      }
   }
...
<head>
   ...
   <title>Bijoux - Actualizar Producto</title>
